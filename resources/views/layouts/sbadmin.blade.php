...
<head>
    ...
    <link href="{{ asset('css/custom//plugins/morris.css') }}" rel="stylesheet">
...
<body>
    ...
    <!-- Custom Scripts -->
    <script src="{{ asset('js/custom/plugins/morris/raphael.min.js') }}"></script>
    <script src="{{ asset('js/custom/plugins/morris/morris.min.js') }}"></script>
    <script src="{{ asset('js/custom/plugins/morris/morris-data.js') }}"></script>
</body>
</html>
